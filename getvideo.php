...
<title>phpzag.com : Demo of YouTube video downloader script in PHP</title>
...
if($status=='fail'){
	echo '<p style="color:red;margin-top:45px;">Error in video ID. Please enter correct Youtube video ID</p>';
...
if ($my_type == 'Download') {
	echo '<p align="left">List of available formats for download:</p>
		<ul>';
	...
	echo '</ul><small>You can download Videos either by clicking video format link or click "download".</small>';
